...
class LaravelH5pServiceProvider extends \Illuminate\Support\ServiceProvider
{
    ...
    public function boot(\Illuminate\Routing\Router $router)
    {
        ...
        $this->publishes([
            ...
            app_path('/../vendor/escolasoft/h5p-core/fonts') => public_path('vendor/h5p/h5p-core/fonts'),
            app_path('/../vendor/escolasoft/h5p-core/images') => public_path('vendor/h5p/h5p-core/images'),
            app_path('/../vendor/escolasoft/h5p-core/js') => public_path('vendor/h5p/h5p-core/js'),
            app_path('/../vendor/escolasoft/h5p-core/styles') => public_path('vendor/h5p/h5p-core/styles'),
            app_path('/../vendor/escolasoft/h5p-editor/ckeditor') => public_path('vendor/h5p/h5p-editor/ckeditor'),
            app_path('/../vendor/escolasoft/h5p-editor/images') => public_path('vendor/h5p/h5p-editor/images'),
            app_path('/../vendor/escolasoft/h5p-editor/language') => public_path('vendor/h5p/h5p-editor/language'),
            app_path('/../vendor/escolasoft/h5p-editor/libs') => public_path('vendor/h5p/h5p-editor/libs'),
            app_path('/../vendor/escolasoft/h5p-editor/scripts') => public_path('vendor/h5p/h5p-editor/scripts'),
            app_path('/../vendor/escolasoft/h5p-editor/styles') => public_path('vendor/h5p/h5p-editor/styles'),
        ], 'public');
    }
